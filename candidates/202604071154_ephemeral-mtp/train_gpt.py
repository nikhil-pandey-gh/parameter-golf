...
class GPT(nn.Module):
    ...
    def _init_weights(self) -> None:
        ...
        # Seed auxiliary heads from the main vocab geometry so MTP gradients reach the trunk immediately.
...
def main() -> None:
    ...
    # - untied output / auxiliary MTP heads -> Adam
    # - bigram proj / VE proj stay with the scalar optimizer (small matrix params)
    matrix_params = [
    ...
    head_params.extend(head.weight for head in base_model.mtp_heads)
    optimizer_head = None
    if head_params:
    ...
    log0(
        ...
        f"head_lr:{args.head_lr if optimizer_head is not None else 0.0} "
