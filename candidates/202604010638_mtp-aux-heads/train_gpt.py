...
def attention_kernel(q: Tensor, k: Tensor, v: Tensor) -> Tensor:
...
def main() -> None:
    ...
    # - bigram proj / VE proj -> Adam; enabled MTP heads join Muon so the auxiliary loss actually trains
    matrix_params = [
