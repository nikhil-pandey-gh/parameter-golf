...
class Hyperparameters:
    ...
    # Keep MTP conservative: one extra horizon and a modest loss weight.
...
class GPT(nn.Module):
    def __init__(
        ...
        # Training-only auxiliary heads; they are excluded from the exported artifact.
...
def main() -> None:
    ...
    # MTP heads are optimization scaffolding only, so keep the artifact on the main model trunk.
