...
def main() -> None:
    ...
    # - token embeddings -> AdamW
    # - scalars/control tensors + small support projections -> AdamW
    # - lm_head + MTP auxiliary heads -> Adam
    matrix_params = [
    ...
    head_params = [head.weight for head in base_model.mtp_heads]
