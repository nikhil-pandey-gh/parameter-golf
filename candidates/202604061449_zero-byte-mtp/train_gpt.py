...
def main() -> None:
    ...
    attention_backend = "flash_attn_3" if use_cuda and flash_attn_3_func is not None else "torch_sdpa"
    log0(f"attention_backend:{attention_backend} compile_model:{int(args.compile_model)}")
    ...
    if use_cuda:
        ...
        log0("peak memory allocated: cpu_run")
