...
def flash_attention(q: Tensor, k: Tensor, v: Tensor, causal: bool) -> Tensor:
...
class GPT(nn.Module):
    ...
    def _init_weights(self) -> None:
        ...
        if self.mtp_init_from_main and len(self.mtp_heads) > 0:
            with torch.no_grad():
                for head in self.mtp_heads:
...
def main() -> None:
    ...
    eval_model = GPT(
        ...
        mtp_num_heads=0, mtp_loss_weight=0.0, mtp_init_from_main=False,
