...
_COMPRESSOR = os.environ.get("ARTIFACT_COMPRESSOR", "zstd")
if _COMPRESSOR not in {"zstd", "zlib"}:
    raise ValueError(f"ARTIFACT_COMPRESSOR must be 'zstd' or 'zlib', got {_COMPRESSOR!r}")
if _COMPRESSOR == "zstd" and zstandard is None:
    raise ImportError("ARTIFACT_COMPRESSOR=zstd requires the zstandard package to be installed")
