...
class Hyperparameters:
    ...
    # Training-only MTP heads are stripped from export below, so they can improve sample
    # efficiency without spending artifact bytes in the final submission.
...
def main() -> None:
    ...
    # - lm_head / MTP heads -> Adam (small output matrices not worth banking)
    matrix_params = [
