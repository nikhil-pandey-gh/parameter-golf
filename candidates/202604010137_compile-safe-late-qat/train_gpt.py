...
def main() -> None:
    ...
    def rebuild_training_model() -> tuple[nn.Module, nn.Module]:
    ...
    compiled_model, model = rebuild_training_model()
    ...
    while True:
        ...
        if distributed and args.late_qat_threshold > 0 and not qat_active:
        ...
        if should_enable_qat:
            ...
            # Recompile once so torch.compile retraces the fake-quant path instead of
            # keeping the earlier no-QAT branch constant-folded away.
            compiled_model, model = rebuild_training_model()
