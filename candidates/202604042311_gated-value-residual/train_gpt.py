...
class Hyperparameters:
    ...
    run_id = os.environ.get("RUN_ID", "202604042311_gated-value-residual")
...
def main() -> None:
    ...
    log0(
        f"candidate:gated_attention:{args.gated_attention} value_residual:{args.value_residual} "
        f"ttt_enabled:{args.ttt_enabled} ttt_freeze_blocks:{args.ttt_freeze_blocks}"
    )
    log0(
