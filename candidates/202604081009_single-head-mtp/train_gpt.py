...
class Hyperparameters:
    ...
    # Training-only future-token heads: exported artifacts strip these params before quantization.
...
def main() -> None:
    ...
    # Keep MTP as a pure training-time auxiliary objective with no artifact-size penalty at export.
