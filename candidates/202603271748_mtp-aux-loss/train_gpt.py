...
class Hyperparameters:
    ...
    # Train-only future-token heads: improve sample efficiency without adding export bytes.
...
def main() -> None:
    ...
    # Keep MTP as a pure auxiliary loss: the exported artifact uses the base next-token model only.
    ...
    eval_model = GPT(
        ...
        mtp_num_heads=0, mtp_loss_weight=0.0,  # Drop auxiliary heads for export/eval roundtrip.
