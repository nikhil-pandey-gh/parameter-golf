...
class Hyperparameters:
    ...
    mtp_anneal_with_lr = bool(int(os.environ.get("MTP_ANNEAL_WITH_LR", "1")))
    ...
    def forward(self, input_ids: Tensor, target_ids: Tensor) -> Tensor:
        ...
        if self.training and self.mtp_num_heads > 0 and self.mtp_loss_weight > 0.0:
            ...
            for k, mtp_head in enumerate(self.mtp_heads):
                ...
                mtp_loss_count += 1
            if mtp_loss_count > 0:
                main_loss = main_loss + self.mtp_weight.to(dtype=main_loss.dtype) * (mtp_loss_sum / mtp_loss_count)
        return main_loss
...
def main() -> None:
    ...
    log0(
        ...
        f"mtp_anneal_with_lr:{args.mtp_anneal_with_lr} mtp_params:{mtp_params}"
    )
    ...
    while True:
        ...
        if args.mtp_num_heads > 0:
            mtp_weight = args.mtp_loss_weight * scale if args.mtp_anneal_with_lr else args.mtp_loss_weight
            base_model.mtp_weight.fill_(mtp_weight)
        ...
        if should_log_train:
            log0(
                ...
                f"mtp_weight:{float(base_model.mtp_weight.item()):.4f} "
