...
class Hyperparameters:
    ...
    mtp_init_from_base = bool(int(os.environ.get("MTP_INIT_FROM_BASE", "1")))
...
class GPT(nn.Module):
    def __init__(
        ...
        self.mtp_init_from_base = mtp_init_from_base
    ...
    def _init_weights(self) -> None:
        ...
        if self.mtp_init_from_base and self.mtp_heads:
            base_weight = self.tok_emb.weight if self.tie_embeddings else self.lm_head.weight
            for head in self.mtp_heads:
                head.weight.data.copy_(base_weight.data)
...
def main() -> None:
    ...
    base_model = GPT(
        ...
        mtp_init_from_base=args.mtp_init_from_base,
    ...
    log0(
        ...
        f"mtp_init_from_base:{args.mtp_init_from_base} mtp_params:{mtp_params}"
    )
