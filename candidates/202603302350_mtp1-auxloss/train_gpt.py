...
class Hyperparameters:
    ...
    # Training-only auxiliary head: excluded from export, so it targets sample efficiency
    # without directly increasing the submission artifact size.
...
def main() -> None:
    ...
    # - scalars/control tensors + small non-banked projection weights -> AdamW
    matrix_params = [
