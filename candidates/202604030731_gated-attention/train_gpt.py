...
class Hyperparameters:
    ...
    attn_gate_bias = float(os.environ.get("ATTN_GATE_BIAS", 4.0))
...
class CausalSelfAttention(nn.Module):
    def __init__(
        ...
        if gated_attention:
            ...
            nn.init.constant_(self.attn_gate.bias, attn_gate_bias)
...
class Block(nn.Module):
    def __init__(
        ...
        self.attn = CausalSelfAttention(dim, num_heads, num_kv_heads, rope_base, qk_gain_init,
                                        gated_attention=gated_attention, attn_gate_bias=attn_gate_bias,
...
def main() -> None:
    ...
    log0(f"gated_attention:{args.gated_attention} attn_gate_bias:{args.attn_gate_bias} value_residual:{args.value_residual}")
    log0(
    ...
    eval_model = GPT(
        ...
        gated_attention=args.gated_attention, attn_gate_bias=args.attn_gate_bias,
        value_residual=args.value_residual,
    ).to(device).bfloat16()
