...
CANDIDATE_DEFAULT_RUN_ID = "202603251556_gated-value-residual"
try:
    import zstandard
    _COMPRESSOR = "zstd"
except ImportError:
...
class Hyperparameters:
    ...
    run_id = os.environ.get("RUN_ID", CANDIDATE_DEFAULT_RUN_ID)
...
def main() -> None:
    ...
    log0(f"candidate:gated_attention={args.gated_attention} value_residual={args.value_residual} ttt_enabled={args.ttt_enabled} lawa_enabled={args.lawa_enabled}")
    log0(
