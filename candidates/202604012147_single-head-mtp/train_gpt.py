...
class Hyperparameters:
    ...
    # Keep MTP conservative: one auxiliary head adds no exported bytes and limits extra train-time cost.
...
def main() -> None:
    ...
    if base_model.mtp_num_heads > 0:
        # Train-only auxiliary heads stay off the parameter banks and are stripped at export.
